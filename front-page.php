  ...
  <section id="destaque-home">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-12 description-destaque">
    ...
    <div class="container">
      ...
      <div class="row" id="debates-home">
        <div class="col-md-4">
          <div class="">
            <div class="text-center">
              <a href="#"><img src="/wp-content/themes/marcocivil-tema/images/logo.png" class="img-adptive" alt="Debate"></a>
            </div>
            <div class="description">
              <a href="#"><strong class="red">Título do Debate</strong>
              <p><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut sit amet cursus metus, nec feugiat sablandit diam facilisis. </small></p></a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="">
            <div class="text-center">
              <a href="#">
                <img src="/wp-content/themes/dadospessoais-tema/images/logo.png" class="img-adptive" alt="Debate">
              </a>
            </div>
            <div class="description">
              <a href="#">
        ...
        <div class="col-md-4">
          <div class="">
            <div class="text-center">
              <a href="/blog/pauta"><img src="/wp-content/themes/pensandoodireito-tema/images/icone-debates.png" class="img-adptive" alt="Debate"></a>
            </div>
            <div class="description">
              <a href="#"><strong class="red">Comece um debate</strong>
              <p><small>Tem algum assunto que quer ver debatido? Faça sua sugestão aqui.</small></p></a>
            </div>
          </div>
        </div>
      </div>
