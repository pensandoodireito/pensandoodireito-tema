<?php get_header(); ?>
	<div id="pagina-debates">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
						...
						<p class="mt-md">A realização de debates envolve cidadãos interessados nas discussões de
							projetos ou anteprojetos de lei, objetivando complementar, ou até mesmo substituir, formas
							tradicionais de elaboração, como por exemplo a formação de comissões de juristas.</p>
					</div>
					<div class="col-sm-5 image-header">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/debates/img-debates-001.png"
						     class="img-full" alt="Proteção de Dados Pessoais">
					</div>
				</div>
			</div>
		</header>
		<?php
		$debate_destaque = new WP_Query( array(
			'post_type'  => 'debate',
			'meta_key'   => 'debate_destaque',
			'meta_value' => 'destaque'
		) );
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="debate-item">
								<header
									style="background-image: url(<?php echo $imagem_fundo; ?>); background-position: center;">
									<div class="text-center">
										<a href="<?php echo $debate_link; ?>"><?php the_post_thumbnail( 'large', array(
												'class' => "img-adptive",
												'alt'   => get_the_title()
											) ); ?></a>
									</div>
								...
								<div class="description">
									...
									<div class="row">
										<div class="col-md-6">
											<p>
												<a href="<?php echo $debate_link; ?>"
												   class="btn btn-danger font-roboto">
										...
										<div class="col-md-6">
											<p class="text-right mt-xs">
												<span class="fontsize-sm text-orange"><i
														class="fa fa-exclamation-triangle"></i> <?php echo( $debate_status == "aberto" ? "Debate aberto até o" : "Debate encerrado" ); ?>
													dia <?php echo pd_converter_datacorrida( $debate_periodo_para ); ?></span>
											</p>
										</div>
									</div>
								</div>
		...
		<?php } ?>
		<?php
		$debates_recentes = new WP_Query( array(
			'post_type'      => 'debate',
									...
									<div class="row">
										<div class="col-sm-2">
											<a href="<?php echo $link; ?>"
											   target="_blank"><?php the_post_thumbnail( 'thumb-debate-pagina', array( 'class' => 'img-adptive' ) ); ?></a>
										</div>
										<div class="col-sm-6">
											<h4><strong class="red"><a href="<?php echo $link; ?>"
											                           target="_blank"><?php the_title(); ?></a></strong>
											</h4>
										...
										<div class="col-sm-4">
											<div class="well well-sm">
												...
												<?php if ( $resultados ): ?>
													<p class="divider-top"><i
															class="fa fa-users"></i><?php echo $resultados; ?></p>
												<?php endif; ?>
