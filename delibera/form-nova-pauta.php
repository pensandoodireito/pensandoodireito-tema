		...
		<div class="clearfix">
			<div class="alignleft">
				<div class="row">
					...
					<input type="text" name="nova-pauta-titulo" id="nova-pauta-titulo"
					       value="<?php echo htmlentities( $titulo ) ?>"
					       placeholder="<?php _e( 'Digite o título da pauta aqui', 'delibera' ); ?>"/>
				</div>
				...
				<div class="row">
					...
					<textarea name="nova-pauta-resumo"
					          id="nova-pauta-resumo"><?php echo htmlentities( $resumo ) ?></textarea>
				</div>
			</div>
				...
				<div class="row">
					...
					<ul>
						<?php foreach ( $temas as $tema ): ?>
							<li><label class="checkbox"><input type="checkbox" name="tema[]"
							                                   value="<?php echo $tema->term_id; ?>"/> <?php echo $tema->name ?>
								</label></li>
						<?php endforeach; ?>
					</ul>
				</div>
