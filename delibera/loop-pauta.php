			...
			<div class="row mt-md divider-bottom">
				...
				<div class="col-md-6">
					<div class="meta text-right">
						<div class="btn-group">
							<button class="btn btn-default btn-sm dropdown-toggle red" type="button"
							        data-toggle="dropdown" aria-expanded="false"><i class="fa fa-chevron-down"></i>
							</button>
							<ul class="dropdown-menu" role="menu">
								<li>
									<a href="javascript:var socialw = window.open('https://www.facebook.com/sharer/sharer.php?u=<?php echo pensandoodireito_bitly_url( get_the_permalink() ); ?>', 'socialw', 'width=470, height=250, location=no');"
									   class="fontsize-sm text-muted"><i class="fa fa-facebook-square"></i> Facebook</a>
								</li>
								<li>
									<a href="javascript:var socialw = window.open('http://www.twitter.com/share?url=<?php echo pensandoodireito_bitly_url( get_the_permalink() ); ?>', 'socialw', 'width=470, height=280, location=no');"
									   class="fontsize-sm text-muted"><i class="fa fa-twitter"></i> Twitter</a>
								</li>
								<li>
									<a href="javascript:var socialw = window.open('https://plus.google.com/share?url=<?php echo pensandoodireito_bitly_url( get_the_permalink() ); ?>', 'socialw', 'width=470, height=250, location=no');"
								...
								<li>
									<a href="?delibera_print=1" class="fontsize-sm text-muted"><i
