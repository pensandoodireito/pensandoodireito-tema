					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<ul class="nav nav-tabs">
								<li class="active">
									<a href="#video-tab" data-toggle="tab"><i class="fa fa-video-camera"></i> Em
										vídeo</a>
								</li>
								<li>
								...
								<div class="tab-pane active" id="video-tab">
									<div class="well well-sm">
										...
										<ul class="small">
											...
											<li>Observe o que vai aparecer no fundo da sua filmagem. Na dúvida, uma
												parede branca é sempre uma boa opção
											</li>
											<li>Seja crítico! Assista a seu vídeo antes de publicá-lo e tente imaginar o
												que outras pessoas achariam dele
											</li>
			...
			<div class="col-md-3">
				<div class="well well-sm">
					...
					<div class="fontsize-sm">
						<p>
							Todas as propostas enviadas passam por uma votação. Os visitantes da plataforma dizem se
							querem ou não participar do debate proposto. </p>

						<p>Se, depois de XXXXX dias em votação, a proposta obtém maioria simples de “Sim”, se transforma
							em um debate e pode começar a receber comentários, opiniões e contribuições. </p>

						<p>Em uma etapa posterior, esse debate pode se tornar ainda uma consulta pública coordenada pelo
							Ministério da Justiça e, eventualmente, se transformar em projeto de lei.</p>
					</div>
				</div>
				<div class="well well-sm">
