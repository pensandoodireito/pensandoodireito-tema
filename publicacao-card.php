...
<li data-id="<?php echo get_the_ID(); ?>" class="publicacoes-item">
	<div class="row">
		<div class="col-sm-9 col-xs-12">
			<div class="descricao">
				...
				<h3 class="h5 red font-roboto">
					<strong>Volume <?php echo get_post_meta( get_the_ID(), 'pub_number', true ); ?></strong>
				</h3>
				</p>
				<h4 class="red h3">
		...
		<div class="col-sm-3 col-xs-12 mt-lg">
			<div class="well well-sm">
				<p><a href="<?php echo get_post_meta( get_the_ID(), 'pub_dld_file', true ); ?>" class="btn btn-default"><i
