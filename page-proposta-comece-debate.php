	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<p>
					<small>criador da proposta: Nome do Criador</small>
				</p>
		...
		<div class="row">
			<div class="col-md-8 col-offset-3">
				<p><strong>RESUMO:</strong> Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-3 text-center">
				...
				<button type="button" class="btn btn-lg btn-success btn-block"><i
						class="fa fa-check-circle fa-2x pull-left"></i>Concordo com a <br>abertura deste debate
				</button>
				<button type="button" class="btn btn-lg btn-danger btn-block">
					<i class="fa fa-times-circle fa-2x pull-left"></i>Discordo da <br> abertura deste debate
				</button>
				<div class="">
					...
					<div class="col-xs-12 col-sm-6 col-lg-12">
						...
						<div class="form-group ">
							<div class="input-group">
								...
								<div class="input-group-addon"><a href="#" class="small pull-right"><i
											class="fa fa-link"></i> copiar link</a></div>
							</div>
						</div>
						<button type="button" class="btn btn-primary btn-block"><i class="fa fa-facebook-square"></i>
							Facebook
						</button>
						<button type="button" class="btn btn btn-info btn-block "><i class="fa fa-twitter-square"></i>
							Twitter
						</button>
					</div>
				</div>
