...
<div id="main-parceiros">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8">
				<p>Parcerias estabelecidas pela SAL/MJ com instituições acadêmicas, centros de pesquisa, ONG’s e também
					com demais entes públicos para a consecução dos objetivos próprios do Projeto Pensando o
					Direito.</p>
				<ul class="list-group">
					<?php while ( have_posts() ): the_post();
						...
						<li class="list-group-item">
							<div class="row">
								...
								<div class="col-sm-9">
									<h4 class="list-group-item-heading"><a href="<?php echo $parceiro_link; ?>"
